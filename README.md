...
- The api is consumed by this [React project](https://github.com/Naledi-Dikgale/hello-react-front-end.git)
...
```
  ...
  git clone https://github.com/Naledi-Dikgale/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/Naledi-Dikgale/hello-rails-back-end/issues).
